            ...
            <div className="container px-3">
                <div className="cta-counter-wrapper-2">
                    ...
                    <div className="section-title-area">
                        ...
                        <div className="counter-box-area">
                            <div className="counter-text wow fadeInUp" data-wow-delay=".3s">
                                <p>
                                    Since 2019, Codersh Web Services has helped businesses
                                    across the US, UK, Asia, and the Netherlands grow through purposeful
                    ...
                    <div
                        ...
                        data-wow-delay="0.3s"
                    >
                        <div className="col-12 col-lg-8"><img src="/assets/img/team/aboutus-gallery-1.webp" alt="" /></div>
                        <div className="col-12 col-lg-4 d-none d-lg-block"><img src="/assets/img/team/aboutus-gallery-2.webp" alt="" /></div>
                    </div>
