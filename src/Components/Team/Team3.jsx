...
const Team3 = () => {
    ...
    const teamContent = [
        { img: '/assets/img/team/team1.webp', name: 'Harsh Shah', content: 'CEO And Founder', instagram: '#', facebook: '#', twitter: '#', linkedin: '#' },
        { img: '/assets/img/team/team2.webp', name: 'Kinjal Shah', content: 'HR Manager', instagram: '#', facebook: '#', twitter: '#', linkedin: '#' },
        { img: '/assets/img/team/team3.webp', name: 'Vishwas Shah', content: 'QA Tester', instagram: '#', facebook: '#', twitter: '#', linkedin: '#' },
        { img: '/assets/img/team/team8.webp', name: 'Sweta Parmar', content: 'Sr.Wordpress Developer', instagram: '#', facebook: '#', twitter: '#', linkedin: '#' },
