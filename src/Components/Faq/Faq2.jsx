...
const Faq2 = ({ addclass }) => {
  const faqContent = [
    {
      title: "How do I request work and get updates on work in progress?",
      content:
    ...
    {
      title: "Can I really have unlimited tasks?",
      content:
        "Nullam faucibus eleifend mi eu varius. Integer vel tincidunt massa, quis semper odio.Mauris et mollis quam. Nullam fringilla erat id ante commodo maximus",
    },
    {
      title: "How long dose it task to get one website done?",
      content:
        "Nullam faucibus eleifend mi eu varius. Integer vel tincidunt massa, quis semper odio.Mauris et mollis quam. Nullam fringilla erat id ante commodo maximus",
    },
    {
      title: "What type of tasks can I assign?",
      content:
        "Nullam faucibus eleifend mi eu varius. Integer vel tincidunt massa, quis semper odio.Mauris et mollis quam. Nullam fringilla erat id ante commodo maximus",
    },
  ];
