...
import overlayImage from "/assets/img/hero/bg-shape.png"; // Adjust the path as necessary
import bgImage from "/assets/img/hero/hero-bg-2.png"; // Adjust the path as necessary
