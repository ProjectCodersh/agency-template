    ...
    const serviceGroups = [
        {
            ...
            items: [
                aboutContent.list1, aboutContent.list2, aboutContent.list3, aboutContent.list4, aboutContent.list6, aboutContent.list7, aboutContent.list8, aboutContent.list9, aboutContent.list10, aboutContent.list11, aboutContent.list12, aboutContent.list13, aboutContent.list14, aboutContent.list15
            ]
        },
        {
            title: chooseHeading.plantitle3,
            items: [
                aboutContent.list21, aboutContent.list22, aboutContent.list23, aboutContent.list24, aboutContent.list25, aboutContent.list26, aboutContent.list12, aboutContent.list13, aboutContent.list14, aboutContent.list15
            ]
        },
        {
            title: chooseHeading.plantitle2,
            items: [
                aboutContent.list16, aboutContent.list17, aboutContent.list18, aboutContent.list19, aboutContent.list20
            ]
        },
        {
            title: chooseHeading.plantitle4,
            items: [
                aboutContent.list29, aboutContent.list30, aboutContent.list31, aboutContent.list32, aboutContent.list33
            ]
        },
        {
            title: chooseHeading.plantitle5,
            items: [
                aboutContent.list34, aboutContent.list35, aboutContent.list36, aboutContent.list37
            ]
        }
    ];
