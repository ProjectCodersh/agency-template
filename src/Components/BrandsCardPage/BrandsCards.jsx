                        ...
                        <div key={i} className="col-xl-6 col-lg-6 col-md-6 mb-5">
                            <div className="case-studies-card-items mt-0">
                                ...
                                <div className="content">
                                    <div className="title">
                                        <h3><Link to={`/brands/${item.slug}`} > {item.title}</Link></h3>
                                        <p>{item.subtitle}</p>
                                        <p className="clamp-2-lines">{item.description}</p>
                                    </div>
                                    <Link to={`/brands/${item.slug}`} className="icon" style={{ minWidth: "52px", height: "52px" }}><i className="bi bi-arrow-up-right"></i></Link>
                                </div>
                            </div>
                        </div>
                    ))}
