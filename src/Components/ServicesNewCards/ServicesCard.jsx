    ...
    return (
        <article className="svc-card h-100 position-relative" tabIndex={0} aria-labelledby={`svc-title-${index}`}>
            ...
            <div className="page-speed-badge">
                ...
                <span className="icon"><img src="/assets/img/check-mark.png" alt="" height="20" className="me-1 mb-1" /></span>
                mail@domain.com
            </div>
            ...
            <div className="svc-content">
                <h3 className="svc-title" id={`svc-title-${index}`}>{service.servicetitle}</h3>
