...
const Testimonial4 = () => {
    ...
    const testimonialContent = [
        { img: '/assets/img/testimonial/01.png', subtitle: 'Founder - Redesignhub', title: 'Theo Doussineau', content: (<>Arvind is as professional as it gets. <br /> Works fast and efficiently. Gets jobs done every time.</>) },
        { img: '/assets/img/testimonial/02.png', subtitle: 'CEO - Strategic Bound', title: 'Marc Philip', content: "Arvind was amazing to work with. The work was so good I didn't need any revisions.Highly recommended!" },
        {
            img: '/assets/img/testimonial/01.png', subtitle: 'San Antonio, Texas', title: 'Luke Jacobs', content: "Arvind exceeded expectations with excellent work and communication. I'd love to work with him again."
        },
        { img: '/assets/img/testimonial/01.png', subtitle: 'Seattle, Washington', title: 'Claire Olson', content: "Great to work with! Made an amazing website for us. We have him our vision and everything came out even better than imagined." },
    ];
