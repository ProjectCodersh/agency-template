            ...
            <div className="client-img d-flex flex-column flex-sm-row align-items-center gap-2">
              ...
              <div className="star-icon text-center text-sm-start">
                <div className="star text-warning">
                  {Array.from(
                    { length: heroContent.review?.ratingStars },
                    (_, i) => (
                  ...
                  {Array.from(
                    {
                      length:
                        heroContent.review?.totalStars -
                        heroContent.review?.ratingStars,
                    },
                    (_, i) => (
            ...
            {heroContent.buttons?.map((btn, idx) => (
              ...
              >
                <Link to={btn.link}>
                  <span
                    className={
                      idx === 1 ? "hero-theme-btn-second" : "hero-theme-btn"
                    }
                  >
                    {btn.label}
                  </span>
